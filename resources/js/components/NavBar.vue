            ...
            <div class="nav-wrapper">
                <div class="container">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li>
                            <router-link to="/profile/my-qr">My QR</router-link>
                        </li>
                        <li>
                            <router-link to="/profile/schedule">My Schedule</router-link>
                        </li>
                        <li v-if="auth">
...
<script>
    export default {
        ...
        methods:{
            logout(){
                window.axios.post('/logout', {_token: document.head.querySelector('meta[name="csrf-token"]')}).then(({data}) => {
